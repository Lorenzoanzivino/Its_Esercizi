'''Esercizio Classi, Ereditarietà: Gestione sistema ospedaliero
...
class Persona(ABC):
    ...
    def __init__(self, first_name: str, last_name: str) -> None:
        # Verifica se first_name è una stringa
        ...
        # Verifica se last_name è una stringa
        ...
        # Imposta l'età in base a nome e cognome se sono stringhe
