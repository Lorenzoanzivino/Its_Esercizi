...
from app.models.citta import Citta
from app.models.nazione import Nazione
from app.database.utils_data_manager import load_nazioni, load_citta, store_nazione
