'''8-10. Inviare messaggi: Inizia con una copia del tuo programma dall'esercizio 8-9. Scrivi una funzione chiamata send-messages() che stampa ogni messaggio di testo e sposta ogni messaggio in un nuovo elenco chiamato send-messages come viene stampato. Dopo aver chiamato la funzione, stampare entrambi gli elenchi per assicurarsi che i messaggi siano stati spostati correttamente.'''
